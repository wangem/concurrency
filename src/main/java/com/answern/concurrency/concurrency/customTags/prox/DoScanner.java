...
//        this.addIncludeFilter(new AnnotationTypeFilter(ProxClient.class));
//    }
//    @Override
...
//        return super.isCandidateComponent(beanDefinition) && beanDefinition.getMetadata().hasAnnotation(ProxClient.class.getName());
//    }
//
//
//}
